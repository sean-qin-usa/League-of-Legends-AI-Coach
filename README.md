...
## Inspiration
After watching a Rank 1 Challenger streamer climb from Iron to Challenger on Nunu, noted by the League of Legends Community as one of the weakest champions in the game, I realized that with precise and consistent decision-making based on high-level concepts, it would be possible for me, a hardstuck Iron player in the bottom 10% of players, to climb too.
